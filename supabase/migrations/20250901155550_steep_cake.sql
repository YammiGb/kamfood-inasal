/*
  # Add Kamfood Inasal Menu Items and Categories

  1. New Categories
    - Add dim-sum, noodles, rice-dishes, beverages categories for Kamfood Inasal
...
-- First, add the new categories for Kamfood Inasal
